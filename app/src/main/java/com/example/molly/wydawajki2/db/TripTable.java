...
public class TripTable
{
    ...
    public TripTable(Context context)
    {
    ...
    public void insertRecord(Integer duserid, Double dusersum,String ddate)
    {
        ...
        sqLiteDatabase.insert(DBHelper.TABLE_TNAME,null,contentValues);
        Log.d("jest", "wpisano do trip");
    }

    public Cursor getAllRecords()
    {
        Log.d("jest", "wypisujenmy");
        return sqLiteDatabase.rawQuery("select * from "+DBHelper.TABLE_TNAME,null);

    }

    public void deleteAllHouseExpenses()
    {
        sqLiteDatabase.delete(DBHelper.TABLE_TNAME,null,null);
    }

    public Cursor getSumAndDate(Integer userid)
    {
        Log.d("jest", "suma+data");
        return sqLiteDatabase.rawQuery("select "+DBHelper.COL_DUSERSUM+","+DBHelper.COL_DDATE+" from "+DBHelper.TABLE_TNAME
    ...
    {
        Log.d("jest", "suma");
        return sqLiteDatabase.rawQuery("select SUM("+DBHelper.COL_DUSERSUM+") "+" from "+DBHelper.TABLE_TNAME
                +" where "+DBHelper.COL_DUSERID+"="+userid,null);
